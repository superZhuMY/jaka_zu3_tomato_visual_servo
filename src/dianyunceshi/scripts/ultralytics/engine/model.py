...
class Model(nn.Module):
    ...
    def val(
        ...
        **kwargs,
        ...
        self.roadseg_val_loader, self.dataset121 = create_road_seg_dataloader(self.data_dict['road_seg_val'], 2,
                                                                              640, 1,
                                                                              32, hyp=self.hyp, cache=True,
                                                                              rect=False,
                                                                              rank=-1,
                                                                              workers=4, pad=0.5)
        seg_weights = self.dataset121.seg_weights
        ...
        print(ave_loss, mean_IoU, IoU_array)
