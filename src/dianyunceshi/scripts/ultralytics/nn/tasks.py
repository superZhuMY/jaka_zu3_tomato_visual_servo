...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolov8n.yaml", ch=3, nc=None, verbose=True):  # model, input channels, number of classes
        ...
        import yaml
        with open("/home/jqr/mzc/shenduxuexi/ultralytics/ultralytics/cfg/models/seg/segheads_c3k5_15_2ceng.yaml", encoding='ascii', errors='ignore') as f2:
            self.seg_yaml = yaml.safe_load(f2)
        ...
        self.model, self.save = parse_model(deepcopy(self.yaml),deepcopy(self.seg_yaml), ch=ch, verbose=verbose)  # model, savelist
...
def parse_model(d,sd, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    # for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m in [CA, CBAM, NAMAttention, GAMAttention,GAMAttention]:
            c1, c2 = ch[f], args[0]
